...
export const Donation = createSlice({
    ...
    reducers:{
        ...
        changeSelectedDonationId:(state,action)=>{
          state.selectedDonationId = action.payload
        },
        changeSelectedDonationInfo:(state,action)=>{
          const foundItem = state.donationItem.find(
            (item) => item.donationItemId === action.payload
          );
          if (foundItem) {
            state.selectedDonationInfo = foundItem;
...
export const {resetToInitial,changeSelectedDonationId,changeSelectedDonationInfo} = Donation.actions;